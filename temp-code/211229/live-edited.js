...
function selectCampaign(id) {
  ...
  // And here is the scroll, which should be used after the "Select campaign"
...
// If the campaign is preselected on page load, no auto-scroll happens as
// this would be disorientating just after page load.
